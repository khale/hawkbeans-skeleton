...
hb_val_from_type (char * str, void * val, u2 desc_idx, java_class_t * cls)
{
    ...
    switch (*desc) {
        case 'B':
            sprintf(str, "%d", (char) val);
            break;
        case 'C':
            sprintf(str, "%c", (u1)val);
            break;
        case 'D':
            sprintf(str, "%f", (d8)(u8)val);
            break;
        case 'F':
            sprintf(str, "%f", (f4)(u4)val);
            break;
        case 'I':
            sprintf(str, "%d", (int)val);
            break;
        case 'J':
            sprintf(str, "%ld", (u8)val);
            break;
        case 'L':
            sprintf(str, "(ref) %p", val);
            break;
        case 'S':
            sprintf(str, "%d", (u2)val);
            break;
        case 'Z':
            sprintf(str, "%s", ((u1)val) == true ? "true" : "false");
            break;
        case '[':
